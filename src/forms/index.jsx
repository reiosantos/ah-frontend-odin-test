...
class FormComponent extends React.Component {
  ...
  constructor(props) {
    ...
    this.customInputs = ['BaseInput', 'Input'];
  ...
  submit(e) {
    ...
    const data = beforeSubmit(this.getFormData());
    ...
    const { defaultFormSubmitter, action, method } = this.props;

    if (action) {
      defaultFormSubmitter({ method, url: action, data })
